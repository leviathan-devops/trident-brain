# COMPACTION SURVIVAL — Kraken Brain Boilerplate (Embedded Edition)

**If context is lost during session compaction, read this file first.**

## Project Identity
- **Project:** [EDIT] Your brain project name
- **Type:** Kraken multi-brain orchestrator brain (embedded-only)
- **Boilerplate:** Kraken-Brain-Edition-v1.0
...
# See: T2_TUI_TESTING.md in Hive Mind
```
...
2. **Brain init must be try/catch** — Plugin crash if init fails
